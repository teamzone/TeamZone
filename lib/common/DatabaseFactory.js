...
function DatabaseFactory() {
    ...
    ///
    /// Returns the club database associated with leveldb data source
    ///
    this.clubdb = function(leveldb)
    {
        return leveldb.sublevel('clubs');
    };

    ///
    /// Returns the squad database associated with leveldb data source
    ///
    this.squaddb = function(leveldb)
    {
        return leveldb.sublevel('squads');
    };
