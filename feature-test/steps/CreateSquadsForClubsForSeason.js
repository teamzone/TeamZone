...
function createSquads(testdata, tms, createdSquads, clubnamefieldname, cityfieldname, seasonfieldname, 
...
module.exports = (function () {
    ...
    return English.library()
        ...
        // Background
        .given("There will be several users as specified in our test user file $testdatafile with details of squads for a club.",
            function (testdatafile, next) {
                //1. Setup Test Data
        ...
        .then("the user will also be marked as the creator of the squad", function (next) {
            ...
            var testdatalength = testdata.length,
                dbh = new dbhelpers(),
                i, j, squadslength,
                currentclubitem, currentsquaditem, club, city, season, adminemail,
