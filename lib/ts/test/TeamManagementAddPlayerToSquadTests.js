...
describe("Team Management Service - Add Player to Squad Unit Tests", function () {
    ...
    it('Will not add a player to a squad when the player is too young', function (done) {
        ...
        // 2. Exercise
        tms.AddPlayerToSquad(clubname, cityname, squadname, season, playeremail, spyCallback, 2014);
    ...
    it('Will not add a player to a squad when the player is too young - using a long past target year like 1999', function (done) {
        ...
        // 2. Exercise
        tms.AddPlayerToSquad(clubname, cityname, squadname, season, playeremail, spyCallback, 1999);
