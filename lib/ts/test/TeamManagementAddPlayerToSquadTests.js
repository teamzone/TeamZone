...
describe("Team Management Service - Add Player to Squad Unit Tests", function () {
    ...
    function assertPlayerAddedToSquad() {
        assert(stubPlayerGet.calledWith(playeremail), 'Checking of the player email did not occur');
    ...
    it('Can add a player to a squad', function (done) {
        ...
        // 2. Exercise
        tms.AddPlayerToSquad(clubname, cityname, squadname, season, playeremail, spyCallback);
    ...
    it('Will not add a player to a squad when the player is too young', function (done) {
        ...
        // 2. Exercise
        tms.AddPlayerToSquad(clubname, cityname, squadname, season, playeremail, spyCallback, 2015);
    ...
    it('Returns error squadname parameter is missing', function (done) {
        ...
        // 2. Exercise
        tms.AddPlayerToSquad(clubname, cityname, null, season, playeremail, spyCallback);
    ...
    it('Returns error season parameter is missing', function (done) {
        ...
        // 2. Exercise
        tms.AddPlayerToSquad(clubname, cityname, squadname, '', playeremail, spyCallback);
    ...
    it('Returns error player email parameter is missing', function (done) {
        ...
        // 2. Exercise
        tms.AddPlayerToSquad(clubname, cityname, squadname, season, undefined, spyCallback);
    ...
    it("Notification of invalid player email error", function (done) {
        ...
        // 2. Exercise
        tms.AddPlayerToSquad(clubname, cityname, squadname, season, '---', spyCallback);
